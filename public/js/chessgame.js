...
//             if (square) {
//                 const pieceElement = create.Element(square, rowIndex, squareIndex);
//                 squareElement.appendChild(pieceElement);
//             }

//             addSquareEventListeners(squareElement);
//             boardElement.appendChild(squareElement);
//         });
//     });
...
// const addSquareEventListeners = (squareElement) => {
...
// // Listen for role assignment and game state updates
// socket.on("playerRole", function(role) {
//     playerRole = role;
//     renderBoard();
// });
...
// // Request initial game state and player role on connection
